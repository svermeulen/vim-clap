...
function! s:action_delete() abort
  ...
  call deletebufline(g:clap.display.bufnr, g:__clap_display_curlnum)
  call g:clap.preview.hide()
  call g:clap#display_win.shrink_if_undersize()
endfunction

function! s:action_open_tab() abort
  call clap#handler#try_open('ctrl-t')
endfunction

function! s:action_open_vertically() abort
  call clap#handler#try_open('ctrl-v')
endfunction
...
let s:buffers.actions = {
      \ 'msg': function('s:actions_title'),
      \ '&Delete': function('s:action_delete'),
      \ 'OpenInNew&Tab': function('s:action_open_tab'),
      \ 'Open&Vertically': function('s:action_open_vertically'),
      \ }
